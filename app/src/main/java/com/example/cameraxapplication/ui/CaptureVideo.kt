...
import com.example.cameraxapplication.extensions.getAspectRatioString
...
//    private val mainThreadExecutor by lazy { ContextCompat.getMainExecutor(requireContext()) }
    ...
    private fun bindCaptureUsecase() {
        ...
        val cameraProviderFeature = remember {
         ...
         val mainThreadExecutor by lazy { ContextCompat.getMainExecutor(context) }
        ...
        AndroidView(factory = { previewView }, modifier = Modifier.fillMaxSize()) {
            cameraProviderFeature.addListener({
                //provider
                val cameraProvider1 = cameraProviderFeature.get()
                ...
                val cameraSelector1 = CameraSelector.DEFAULT_FRONT_CAMERA
        ...
        BoxWithConstraints {
            ...
            val aspectRatioString = quality.getAspectRatioString(quality, orientation == Configuration.ORIENTATION_PORTRAIT)
            Surface(modifier = Modifier.aspectRatio("aspectRatioString")) {
                // add PreviewView content here
            }
        }
...
//            }
     ...
     */
    private fun getCameraSelector(idx: Int,context: Context) : CameraSelector {
